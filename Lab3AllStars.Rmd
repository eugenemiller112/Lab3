...
### Eugene Miller
```{r Eugenes_Code, echo = FALSE, message = FALSE, fig.width=12, fig.height=8}
...
ggplot(cdc) +
  geom_density(mapping=aes(x=age, color=genhlth), alpha=.6, bins=30) +
...
**Findings**: Smokers seem more likely to have poor health at a older age while non-smokers seem to be more likely to have excellent/very good health at a younger age. Besides that there seems to be no significant difference between the groups.
...
__Explanation:__ My plot is to count the number of people who  smokes and who does smoke.
