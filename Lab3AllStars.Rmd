...
ggplot(data = cdc) +
 geom_col(mapping = aes(x = smoke100, y = hlthplan, color = smoke100), show.legend = FALSE) +
 labs(y = "Subjects with Health Plan") +
 facet_wrap(~smoke100, labeller = labeller(smoke100 = smoke.labs)) +
 theme(axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks.x=element_blank()) 
```

_Findings_:
My plot compares the number of non-smokers and smokers who have a health care plan, and it finds that non-smokers have a higher rate of people covered by healthcare.